...
Same as initialize_bins_obb_cut_overlap.py, but each bin is drawn and saved as its FULL detected
...
Use this when you want the original detected boxes untouched. Use initialize_bins_obb_cut_overlap.py
